...
export class CidadeService {
  ...
  findById(id: any): Observable<Cidade> {
    return this.httpClient.get<Cidade>(`${this.baseUrl}/api/cidade/${id}`, this.httpOptions);
}

create(cidade: Cidade): Observable<Cidade> {
    return this.httpClient.post<Cidade>(`${this.baseUrl}/api/cidade`, cidade, this.httpOptions);
}

update(cidade: Cidade): Observable<Cidade> {
  return this.httpClient.put<Cidade>(
    `${this.baseUrl}/api/cidade/${cidade?.cidId}`,
    cidade,
    this.httpOptions
  );
}
